...
- [Bulk files importer](https://github.io.sked/docs/tree/master/docs-importer) (single or scan mode)
...
#### Download
The latest release is downloadable here: <https://github.io.sked/docs/releases> in WAR format. 
**The default admin password is "admin". Don't forget to change it before going to production.**
...
First off, clone the repository: `git clone git://github.io.sked/docs.git`
